...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleDuplicate(DuplicateAppointmentException ex) {
        return buildError(HttpStatus.CONFLICT, ex.getMessage());
    }

    @ExceptionHandler(BillAlreadyExistsException.class)
    public ResponseEntity<Map<String, Object>> handleBillExists(BillAlreadyExistsException ex) {
        return buildError(HttpStatus.CONFLICT, ex.getMessage());
    }

    @ExceptionHandler(InvalidTreatmentTypeException.class)
    public ResponseEntity<Map<String, Object>> handleInvalidTreatment(InvalidTreatmentTypeException ex) {
